...
case class StacItemAssetRasterSource(
  asset: StacItemAsset,
  ...
  def reprojection(targetCRS: CRS, resampleTarget: ResampleTarget, method: ResampleMethod, strategy: OverviewStrategy): StacItemAssetRasterSource =
    StacItemAssetRasterSource(asset, itemProperties, underlying.reproject(targetCRS, resampleTarget, method, strategy).some, targetCellType)

  def resample(resampleTarget: ResampleTarget, method: ResampleMethod, strategy: OverviewStrategy): StacItemAssetRasterSource =
    StacItemAssetRasterSource(asset, itemProperties, underlying.resample(resampleTarget, method, strategy).some, targetCellType)
  ...
  def convert(targetCellType: TargetCellType): StacItemAssetRasterSource =
    StacItemAssetRasterSource(asset, itemProperties, underlying.convert(targetCellType).some, targetCellType.some)
