...
object MosaicRasterSource {
   ...
   */
  def instanceGridExtent[F[_]: Monad: Parallel: MonadThrow](sourcesList: F[NonEmptyList[F[RasterSource]]], targetCRS: F[CRS], targetGridExtent: F[GridExtent[Long]], sourceName: SourceName): MosaicRasterSource[F] =
   ...
   */
  def instance[F[_]: Monad: Parallel: MonadThrow](sourcesList: F[NonEmptyList[F[RasterSource]]], targetCRS: F[CRS], sourceName: SourceName = EmptyName): MosaicRasterSource[F] = {
  ...
  def applyGridExtent[F[_]: Monad: Parallel: MonadThrow](sourcesList: F[NonEmptyList[F[RasterSource]]], targetCRS: F[CRS], targetGridExtent: F[GridExtent[Long]], rasterSourceName: SourceName = EmptyName): MosaicRasterSource[F] = {
    new MosaicRasterSource[F] {
  ...
  def apply[F[_]: Monad: Parallel: MonadThrow](sourcesList: F[NonEmptyList[F[RasterSource]]], targetCRS: F[CRS], rasterSourceName: SourceName): MosaicRasterSource[F] = {
    new MosaicRasterSource[F] {
      val name: SourceName = rasterSourceName
      val sources: F[NonEmptyList[F[RasterSource]]] = {
