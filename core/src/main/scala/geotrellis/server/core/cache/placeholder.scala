...
//class LocalCacheClient(client: => MemcachedClient) extends LazyLogging with RollbarNotifier {}

//class MemcachedCacheClient(client: => MemcachedClient) extends LazyLogging with RollbarNotifier {
